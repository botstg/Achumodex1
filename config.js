...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~DJJTKhAf",
  MENU_URL: process.env.MENU_URL || "https://ik.imagekit.io/eypz/1722873079279_lHOJlrddC.png",
  CAPTION: process.env.CAPTION || "iroenisrv",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "iroenisrv",
  BOT_NAME: process.env.BOT_NAME || "iroenisrv",
  ...
  PROCESSNAME: process.env.PROCESSNAME || "iroenisrv",
  AUTHOR: process.env.AUTHOR || "iroenisrv",
